...
import { IconArrowDownRight, IconArrowUpRight, IconBell, IconBox, IconChevronRight, IconCreditCard, IconPackage, IconPlus, IconReceipt, IconSettings, IconSparkles, IconUsers, IconWallet } from "@tabler/icons-react";
...
const navItems = [
  { label: "Overview", icon: IconArrowUpRight, to: "/" },
...
export function DashboardView({ organizations, organizationId, onOrganizationChange, summary, sales, expenses, loading, error }: Props) {
